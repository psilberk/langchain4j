 ...
 * </p><p>
 * A vector index can be created on the {@link EmbeddingTable} using a {@link VectorIndexBuilder}. Two types of vector
 * indexes are supported:
 * <ul>
 *   <li><em>Inverted File Flat (IVF)</em>: which can be created using the {@link IVFIndexBuilder} class.</li>
 *   <li><em>Hierarchical Navigable Small World (HNSW)</em>: which can be created using the {@link HNSWIndexBuilder}
 *   class.</li>
 * </ul>
 * </p><p>
