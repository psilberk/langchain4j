...
public final class EmbeddingTable {
    ...
    private EmbeddingTable(Builder builder) {
        ...
        vectorIndexBuilder = builder.vectorIndexBuilder;
    }
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            if (vectorIndexBuilder != null) {
                ...
                if (createStatement != null) {
                    statement.addBatch(createStatement);
                }
            }
    ...
    public static class Builder {
        ...
        private VectorIndexBuilder vectorIndexBuilder;
        ...
        /**
         * Configures the vector index builder.
         * @param vectorIndexBuilder The vector index builder.
         * @return This Builder.
         */
        public Builder vectorIndexBuilder(VectorIndexBuilder vectorIndexBuilder) {
